...
- [bootstrap-restore-flow](bootstrap-restore-flow.md) — char-bootstrap mismatch, 'l' seed fix, disambiguation mode gotcha, suppress logic (zvm, save-restore, voxglk) — updated 2026-05-09
...
- [save-system](save-system.md) — Autosave vs quicksave semantics; storage layout; sanitizer note (save, restore, design) — updated 2026-04-26
