...
- [service-worker-update-model](service-worker-update-model.md) — Silent SW activation (v1.5.476+): network-first fetch strategy makes toast+forced-reload redundant; new worker activates silently, next natural reload picks up everything (pwa, service-worker, update, cache, design) — updated 2026-06-04
