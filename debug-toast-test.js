...
console.log('Dismissed toasts:', localStorage.getItem('lantern_map_toasts_dismissed'));
console.log('First use flag:', localStorage.getItem('lantern_map_first_use_shown'));

// Clear toast flags to see them again
localStorage.removeItem('lantern_map_toasts_dismissed');
localStorage.removeItem('lantern_map_first_use_shown');
