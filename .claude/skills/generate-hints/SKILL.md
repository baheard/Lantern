...
2. **Don't presume possession or progress in the question.** "I have three pearls — where's the green one?" leaks that pearls are collectible, that there are four, and one is green. Anchor to a single observable instead: "What's this strange eye-like pearl for?" State-scoping belongs in section order and in-ladder gates, not question text.
