...
| Medium | `save-manager.js:102-222,230-310` | Map-domain logic (200 lines) embedded in save module â€” belongs in map-canvas.js |
...
| Medium | `settings-panel.js:171-281` | `showBackupSavesDialog()` 111-line inline modal â€” move to `ui/backup-saves-dialog.js` |
