...
- [ ] **Add "Restoring..." overlay** - Visual feedback during game transition/load
- [ ] **Clear old backup saves** - Trim rotating backup chain for games not played in a long time (keep primary autosave)
...
- [ ] **Cloud TTS** - Research Google/Amazon/OpenAI TTS APIs for better Bluetooth audio quality
